...
internal class CActPerfStageFailure : CActivity
{
    ...
    public override int OnUpdateAndDraw()
    {
        ...
        if (ct進行.nCurrentValue < 100)
        {
            ...
            {
                txStageFailed.tDraw2D(CDTXMania.app.Device, 0, 0, new RectangleF(x, 0, 640 - x, 720));
                txStageFailed.tDraw2D(CDTXMania.app.Device, 640 + x, 0, new RectangleF(640, 0, 640 - x, 720));
            }
        }
        else
        {
