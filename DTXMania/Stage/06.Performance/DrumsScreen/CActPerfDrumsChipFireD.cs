		...
		if( bActivated )
		{
			for (int i = 0; i < STAR_MAX; i++)
			{
				if (st青い星[i].b使用中)
				{
					...
					mat *= Matrix.Translation(st青い星[i].fX - GameFramebufferSize.Width / 2, -(st青い星[i].fY - GameFramebufferSize.Height / 2), 0f);
			...
			if (CDTXMania.ConfigIni.eAttackEffect.Drums == EType.A)
			{
				for (int i = 0; i < 8; i++)
				{
					if (st飛び散るチップ[i].b使用中)
					{
						...
						mat *= Matrix.Translation((st飛び散るチップ[i].fXL - 50f) - GameFramebufferSize.Width / 2, -(st飛び散るチップ[i].fY + nJudgeLinePosY_delta_Drums - GameFramebufferSize.Height / 2), 0f);
						mat2 *= Matrix.Translation((st飛び散るチップ[i].fXR - 50f) - GameFramebufferSize.Width / 2, -(st飛び散るチップ[i].fY + nJudgeLinePosY_delta_Drums - GameFramebufferSize.Height / 2), 0f);
						//mat *= Matrix.Translation(this.st飛び散るチップ[i].fX - GameFramebufferSize.Width / 2, -(this.st青い星[i].fY - GameFramebufferSize.Height / 2), 0f);
				...
				if( st大波[ i ].b使用中 )
				{
					...
					if( st大波[ i ].ct進行.nCurrentValue >= 0 )
					{
						...
						if (CDTXMania.ConfigIni.eLaneType.Drums == EType.A)
						{
							if (CDTXMania.ConfigIni.eRDPosition == ERDPosition.RDRC)
							{
								matrix3 *= Matrix.Translation(nレーンの中央X座標_改[st大波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
							else
							{
								matrix3 *= Matrix.Translation(nレーンの中央X座標[st大波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
						}
						else if (CDTXMania.ConfigIni.eLaneType.Drums == EType.B)
						{
							if (CDTXMania.ConfigIni.eRDPosition == ERDPosition.RDRC)
							{
								matrix3 *= Matrix.Translation(nレーンの中央X座標B_改[st大波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
							else
							{
								matrix3 *= Matrix.Translation(nレーンの中央X座標B[st大波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
						}
						else if (CDTXMania.ConfigIni.eLaneType.Drums == EType.C)
						{
							if (CDTXMania.ConfigIni.eRDPosition == ERDPosition.RDRC)
							{
								matrix3 *= Matrix.Translation(nレーンの中央X座標C_改[st大波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
							else
							{
								matrix3 *= Matrix.Translation(nレーンの中央X座標C[st大波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
						}
						else if (CDTXMania.ConfigIni.eLaneType.Drums == EType.D)
						{
							if (CDTXMania.ConfigIni.eRDPosition == ERDPosition.RDRC)
							{
								matrix3 *= Matrix.Translation(nレーンの中央X座標D_改[st大波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
							else
							{
								matrix3 *= Matrix.Translation(nレーンの中央X座標D[st大波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
						}
						if( tx大波 != null )
						{
				...
				if( st細波[ i ].b使用中 )
				{
					...
					if( st細波[ i ].ct進行.nCurrentValue >= 0 )
					{
						...
						if (CDTXMania.ConfigIni.eLaneType.Drums == EType.A)
						{
							...
							{
								matrix4 *= Matrix.Translation(nレーンの中央X座標[st細波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
							else
							{
								matrix4 *= Matrix.Translation(nレーンの中央X座標_改[st細波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
						}
						else if (CDTXMania.ConfigIni.eLaneType.Drums == EType.B)
						{
							if (CDTXMania.ConfigIni.eRDPosition == ERDPosition.RCRD)
							{
								matrix4 *= Matrix.Translation(nレーンの中央X座標B[st細波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
							else
							{
								matrix4 *= Matrix.Translation(nレーンの中央X座標B_改[st細波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
						}
						else if (CDTXMania.ConfigIni.eLaneType.Drums == EType.C)
						{
							if (CDTXMania.ConfigIni.eRDPosition == ERDPosition.RCRD)
							{
								matrix4 *= Matrix.Translation(nレーンの中央X座標C_改[st細波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
							else
							{
								matrix4 *= Matrix.Translation(nレーンの中央X座標C[st細波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
						}
						else if (CDTXMania.ConfigIni.eLaneType.Drums == EType.D)
						{
							if (CDTXMania.ConfigIni.eRDPosition == ERDPosition.RDRC)
							{
								matrix4 *= Matrix.Translation(nレーンの中央X座標D_改[st細波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
							else
							{
								matrix4 *= Matrix.Translation(nレーンの中央X座標D[st細波[i].nLane] + 280 - GameFramebufferSize.Width / 2, -(iPosY + nJudgeLinePosY_delta_Drums + 200 - GameFramebufferSize.Height / 2), 0f);
							}
						}
						if (tx細波 != null)
						{
