                        ...
                        //if (base.tx判定文字列[num4] != null)
                        {
                            if (CDTXMania.ConfigIni.nJudgeFrames > 1 && CDTXMania.stagePerfGuitarScreen.tx判定画像anime != null)
                            {
                                if (st状態[j].judge == EJudgement.Perfect)
                                {
                                    ...
                                    CDTXMania.stagePerfGuitarScreen.tx判定画像anime.tDraw2D(CDTXMania.app.Device, x, y, new Rectangle(0, nRectY * st状態[j].nRect, nRectX, nRectY));
                                }
                                if (st状態[j].judge == EJudgement.Great)
                                {
                                    ...
                                    CDTXMania.stagePerfGuitarScreen.tx判定画像anime.tDraw2D(CDTXMania.app.Device, x, y, new Rectangle(nRectX * 1, nRectY * st状態[j].nRect, nRectX, nRectY));
                                }
                                if (st状態[j].judge == EJudgement.Good)
                                {
                                    ...
                                    CDTXMania.stagePerfGuitarScreen.tx判定画像anime.tDraw2D(CDTXMania.app.Device, x, y, new Rectangle(nRectX * 2, nRectY * st状態[j].nRect, nRectX, nRectY));
                                }
                                if (st状態[j].judge == EJudgement.Poor)
                                {
                                    ...
                                    CDTXMania.stagePerfGuitarScreen.tx判定画像anime.tDraw2D(CDTXMania.app.Device, x, y, new Rectangle(nRectX * 3, nRectY * st状態[j].nRect, nRectX, nRectY));
                                }
                                if (st状態[j].judge == EJudgement.Miss)
                                {
                                    ...
                                    CDTXMania.stagePerfGuitarScreen.tx判定画像anime.tDraw2D(CDTXMania.app.Device, x, y, new Rectangle(nRectX * 4, nRectY * st状態[j].nRect, nRectX, nRectY));
                                }
                                if (st状態[j].judge == EJudgement.Auto)
                                {
                                    ...
                                    CDTXMania.stagePerfGuitarScreen.tx判定画像anime.tDraw2D(CDTXMania.app.Device, x, y, new Rectangle(nRectX * 5, nRectY * st状態[j].nRect, nRectX, nRectY));
                                }
                            }
                    ...
                    else if (CDTXMania.ConfigIni.nJudgeAnimeType == 2)
                    {
                        ...
                        if (CDTXMania.stagePerfGuitarScreen.tx判定画像anime != null)
                        {
                            if (st状態[j].judge == EJudgement.Perfect)
                            {
                                ...
                                CDTXMania.stagePerfGuitarScreen.tx判定画像anime_3.nTransparency = st状態[j].n透明度B;
