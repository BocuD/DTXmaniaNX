...
internal partial class CActConfigList
{
    ...
    public void tSetupItemList_Drums()
    {
        ...
        CItemList? iDrumsHIDSUD = new("HID-SUD", CItemBase.EPanelType.Normal, (int)CDTXMania.ConfigIni.nHidSud.Drums,
        ...
        CItemList? iDrumsLaneDisp = new("LaneDisp", CItemBase.EPanelType.Normal, (int)CDTXMania.ConfigIni.nLaneDisp.Drums,
