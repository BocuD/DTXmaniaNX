...
internal partial class CActConfigList
{
    ...
    public void tSetupItemList_Bass()
    {
        ...
        CItemBase iBassGoToKeyAssign = new("Input Mapping", CItemBase.EPanelType.Folder,
            "ベースのキー入力に関する項目を設定します。",
            "P2 guitar input mapping configuration.")
        {
    ...
    private void tSetupItemList_KeyAssignBass()
    {
        ...
        {
            action = () => stageConfig.tNotifyPadSelection(EKeyConfigPart.BASS, EKeyConfigPad.R)
        };
        ...
        {
            action = () => stageConfig.tNotifyPadSelection(EKeyConfigPart.BASS, EKeyConfigPad.G)
        };
        ...
        {
            action = () => stageConfig.tNotifyPadSelection(EKeyConfigPart.BASS, EKeyConfigPad.B)
        };
        ...
        {
            action = () => stageConfig.tNotifyPadSelection(EKeyConfigPart.BASS, EKeyConfigPad.Y)
        };
        ...
        {
            action = () => stageConfig.tNotifyPadSelection(EKeyConfigPart.BASS, EKeyConfigPad.P)
        };
        ...
        {
            action = () => stageConfig.tNotifyPadSelection(EKeyConfigPart.BASS, EKeyConfigPad.Pick)
        };
        ...
        {
            action = () => stageConfig.tNotifyPadSelection(EKeyConfigPart.BASS, EKeyConfigPad.Wail)
        };
        ...
        {
            action = () => stageConfig.tNotifyPadSelection(EKeyConfigPart.BASS, EKeyConfigPad.Decide)
        };
        ...
        {
            action = () => stageConfig.tNotifyPadSelection(EKeyConfigPart.BASS, EKeyConfigPad.Cancel)
        };
