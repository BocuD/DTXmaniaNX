...
internal partial class CConfigIni
{
	...
	[
		new("System", [
			...
			G(["メニューの上下移動にピックを使う (0:OFF(R/G), 1:ON)。選曲画面の曲リストは常に R/G。",
					"Move through menus with the up and down picks (0:OFF, uses R and G; 1:ON). The song list always uses R and G."],
				Bool("StrumScrollsMenus", c => c.bStrumScrollsMenus)),
